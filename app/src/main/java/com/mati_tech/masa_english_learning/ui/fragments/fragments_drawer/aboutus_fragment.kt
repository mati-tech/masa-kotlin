 ...
 * Use the [aboutus_fragment.newInstance] factory method to
...
class aboutus_fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_aboutus_fragment, container, false)
    }
